...
import { ShowErrorClienteState, ShowClienteState } from '@register/domain/state/register-person-state';
...
@Injectable()
export class ClienteCnpjUseCase implements Usecase<ClientData, State> {

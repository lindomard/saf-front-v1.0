...
@Component({
  selector: 'app-gerar-arq-magnetico',
  templateUrl: './gerar-arq-magnetico.component.html',
  styleUrls: ['./gerar-arq-magnetico.component.scss']
})
export class GerarArqMagneticoComponent implements OnInit {

...
@Component({
  selector: 'app-historico-geracao-arquivos-sintegra',
  templateUrl: './historico-geracao-arquivos-sintegra.component.html',
  styleUrls: ['./historico-geracao-arquivos-sintegra.component.scss']
})
export class HistoricoGeracaoArquivosSintegraComponent implements OnInit {

...
export class ProcessarSintegraService {
  ...
  gerarArqMagneticos(parametrosDados: ParametrosDados): Observable<RespostaComMensagemModel> {
    let url = "gerarEfdIcms";
    return this.api.post(url,parametrosDados);
  
  }

  gerarArqMagneticosSintegra(parametrosDados: ParametrosDados): Observable<RespostaComMensagemModel> {
    let url = "gerarSintegra";
    return this.api.post(url,parametrosDados);
  }
